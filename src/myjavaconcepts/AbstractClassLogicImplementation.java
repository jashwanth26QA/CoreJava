...
public class AbstractClassLogicImplementation extends AbstractMyClass {
    ...
    For that contructor to be called we need to extend in child class
    In child class constructor we can call using super keyword and it should be only in child class constructor
